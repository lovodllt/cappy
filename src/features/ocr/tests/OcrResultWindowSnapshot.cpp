...
QImage buildPreviewImage() {
    ...
    painter.drawText(QRect(128, 132, 900, 42), Qt::AlignLeft | Qt::AlignVCenter, QStringLiteral("Invoice #A-240624"));

    QFont bodyFont = painter.font();
    bodyFont.setPointSize(18);
    bodyFont.setBold(false);
    painter.setFont(bodyFont);
    painter.drawText(QRect(128, 206, 700, 34), Qt::AlignLeft | Qt::AlignVCenter, QStringLiteral("Customer  Sunny Capturer Studio"));
    painter.drawText(QRect(128, 260, 520, 34), Qt::AlignLeft | Qt::AlignVCenter, QStringLiteral("Date  2026-06-24"));
    painter.drawText(QRect(128, 314, 600, 34), Qt::AlignLeft | Qt::AlignVCenter, QStringLiteral("Amount  CNY 1299.00"));
    painter.drawText(QRect(128, 420, 880, 34), Qt::AlignLeft | Qt::AlignVCenter, QStringLiteral("Please review the recognized text on the right."));
    painter.end();
    return image;
}
...
cappy::services::ocr::OcrResult buildMockResult() {
    ...
    result.regions = {
        ...
        OcrTextRegion{QRect(126, 196, 506, 34), QStringLiteral("Customer  Sunny Capturer Studio"), 94},
        ...
        OcrTextRegion{QRect(126, 410, 698, 34), QStringLiteral("Please review the recognized text on the right."), 91},
    };
    return result;
}
...
int main(int argc, char* argv[]) {
    ...
    const QString outputPath = argc >= 2
        ...
        : QStringLiteral("/tmp/cappy-ocr-result.png");
