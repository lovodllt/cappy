...
#define CAPPY_SHORTCUT_FIELD_LIST(X)                                                               \
    X("global.open_home", ShortcutScope::Global, "Open Cappy", "Ctrl+Shift+Space",                 \
      global.openHome)                                                                             \
    X("global.screenshot", ShortcutScope::Global, "Screenshot", "F1", global.screenshot)           \
    X("main.region_capture", ShortcutScope::MainWindow, "Region Capture", "Ctrl+Shift+A",          \
      mainWindow.regionCapture)                                                                    \
    X("main.fullscreen_capture", ShortcutScope::MainWindow, "Fullscreen Capture", "Ctrl+Shift+F",  \
      mainWindow.fullscreenCapture)                                                                \
    X("main.active_window_capture", ShortcutScope::MainWindow, "Active Window Capture",            \
      "Ctrl+Shift+W", mainWindow.activeWindowCapture)                                              \
    X("main.pin_latest", ShortcutScope::MainWindow, "Pin Last Capture", "Ctrl+Shift+P",            \
      mainWindow.pinLatest)                                                                        \
    X("main.save_latest", ShortcutScope::MainWindow, "Save Last Capture", "Ctrl+S",                \
      mainWindow.saveLatest)                                                                       \
    X("main.close_pins", ShortcutScope::MainWindow, "Close Pins", "Ctrl+Alt+X",                    \
      mainWindow.closePins)                                                                        \
    X("main.restore_pin_input", ShortcutScope::MainWindow, "Restore Pin Input", "Ctrl+Alt+R",      \
      mainWindow.restorePinInput)                                                                  \
    X("main.open_capture_folder", ShortcutScope::MainWindow, "Open Capture Folder", "Ctrl+O",      \
      mainWindow.openCaptureFolder)                                                                \
    X("main.settings", ShortcutScope::MainWindow, "Settings", "Ctrl+,", mainWindow.settings)       \
    X("main.hide_to_tray", ShortcutScope::MainWindow, "Hide to Tray", "Ctrl+H",                    \
      mainWindow.hideToTray)                                                                       \
    X("main.quit", ShortcutScope::MainWindow, "Quit", "Ctrl+Q", mainWindow.quit)                   \
    X("main.history_pin", ShortcutScope::MainWindow, "History: Pin Selected", "Return",            \
      mainWindow.historyPin)                                                                       \
    X("main.history_copy", ShortcutScope::MainWindow, "History: Copy Selected", "Ctrl+C",          \
      mainWindow.historyCopy)                                                                      \
    X("main.history_save", ShortcutScope::MainWindow, "History: Save Selected", "Ctrl+Shift+S",    \
      mainWindow.historySave)                                                                      \
    X("main.history_remove", ShortcutScope::MainWindow, "History: Remove Selected", "Delete",      \
      mainWindow.historyRemove)                                                                    \
    X("overlay.rectangle", ShortcutScope::CaptureOverlay, "Tool: Rectangle", "1",                  \
      overlay.rectangle)                                                                           \
    ...
    X("overlay.rectangle_alt", ShortcutScope::CaptureOverlay, "Tool: Rectangle Alt", "Ctrl+1",     \
      overlay.rectangleAlt)                                                                        \
    X("overlay.ellipse_alt", ShortcutScope::CaptureOverlay, "Tool: Ellipse Alt", "Ctrl+2",         \
      overlay.ellipseAlt)                                                                          \
    X("overlay.arrow_alt", ShortcutScope::CaptureOverlay, "Tool: Arrow Alt", "Ctrl+3",             \
      overlay.arrowAlt)                                                                            \
    X("overlay.pen_alt", ShortcutScope::CaptureOverlay, "Tool: Pen Alt", "Ctrl+4", overlay.penAlt) \
    X("overlay.marker_alt", ShortcutScope::CaptureOverlay, "Tool: Marker Alt", "Ctrl+5",           \
      overlay.markerAlt)                                                                           \
    X("overlay.mosaic_alt", ShortcutScope::CaptureOverlay, "Tool: Mosaic Alt", "Ctrl+6",           \
      overlay.mosaicAlt)                                                                           \
    X("overlay.text_alt", ShortcutScope::CaptureOverlay, "Tool: Text Alt", "Ctrl+7",               \
      overlay.textAlt)                                                                             \
    X("overlay.serial_alt", ShortcutScope::CaptureOverlay, "Tool: Serial Alt", "Ctrl+8",           \
      overlay.serialAlt)                                                                           \
    ...
    X("overlay.quick_copy", ShortcutScope::CaptureOverlay, "Quick Copy", "Return",                 \
      overlay.quickCopy)                                                                           \
    ...
    X("editor.rectangle", ShortcutScope::CaptureEditor, "Tool: Rectangle", "Ctrl+1",               \
      editor.rectangle)                                                                            \
    ...
    X("editor.copy_and_close", ShortcutScope::CaptureEditor, "Copy And Close", "Return",           \
      editor.copyAndClose)                                                                         \
    ...
    X("pin.reset_scale_opacity", ShortcutScope::PinWindow, "Reset Scale And Opacity", "0",         \
      pinWindow.resetScaleAndOpacity)                                                              \
    ...
    X("pin.toggle_click_through", ShortcutScope::PinWindow, "Toggle Click-Through", "T",           \
      pinWindow.toggleClickThrough)
